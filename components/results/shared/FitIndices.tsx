...
const safeToFixed = (val: any, decimals: number) => {
            ...
            {indices.chisq !== undefined && indices.df !== undefined && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="text-xs text-gray-600">
                        <span className="font-semibold">χ² Test:</span> χ²({indices.df}) = {safeToFixed(indices.chisq, 2)}
                        {indices.pvalue !== undefined && (
                            <span>, p = {safeToFixed(indices.pvalue, 4)}</span>
                        )}
                    </div>
                </div>
            )}
