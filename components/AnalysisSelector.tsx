        ...
        },
        {
            ...
            category: {
                ...
                options: [
                    ...
                    { id: 'cfa-select', title: 'CFA', desc: 'Confirmatory Factor Analysis', icon: Network, action: 'select', costType: 'cfa', disabled: true, badge: 'Soon' },
                    { id: 'sem-select', title: 'SEM', desc: 'Structural Equation Modeling', icon: Layers, action: 'select', costType: 'sem', disabled: true, badge: 'Soon' },
                ]
            }
        },
        {
