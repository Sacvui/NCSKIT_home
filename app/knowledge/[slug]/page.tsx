...
Việc báo cáo được HTMT cho thấy bạn là một nhà nghiên cứu am tường và luôn cập nhật những xu hướng thống kê hiện đại nhất thế giới.`,
    ...
    'interaction-effects-moderation': {
        ...
        content_structure: [
            {
                h2_vi: '1. Biến điều tiết là gì?',
                h2_en: '1. What is a Moderator?',
                content_vi: `Biến điều tiết (Moderator) trả lời cho câu hỏi: Tác động của X lên Y mạnh hay yếu tùy thuộc vào yếu tố nào? Ví dụ: Công nghệ Blockchain có giúp Marketing xanh tác động mạnh hơn đến niềm tin không? ncsStat giúp bạn kiểm định sự "nhạy cảm" này của mô hình.`,
                content_en: `A moderator answers "When?" or "For whom?" does an effect happen. e.g., Does Blockchain amplify the impact of Green Marketing on Trust? ncsStat tests these contingent relationships.`
            },
            {
                h2_vi: '2. Cách đọc Slope Plot: Nghệ thuật trực quan hóa',
                h2_en: '2. Interpreting Slope Plots',
                content_vi: `Khi biến tương tác có ý nghĩa, đồ thị Simple Slope sẽ cho bạn thấy sự khác biệt. Nếu các đường thẳng không song song, bạn đã tìm thấy hiệu ứng điều tiết. ncsStat xuất bản các đồ thị này chuẩn APA để bạn đưa vào bài.` ,
                content_en: `If lines aren't parallel in a Simple Slope plot, you have moderation. ncsStat generates high-quality plots to visualize how the effect of X changes at different levels of M.`
            }
        ]
    },
    'manipulation-check-scenario': {
        ...
        content_structure: [
            {
                h2_vi: '1. Tại sao cần Check?',
                h2_en: '1. Why Check?',
                content_vi: `Trong khảo sát kịch bản (Scenario-based), bạn phải chứng minh người trả lời thực sự nhận ra sự khác biệt giữa các kịch bản. ncsStat giúp bạn chạy T-Test để khẳng định kịch bản của bạn đã "chạm" đến nhận thức của người dùng.`,
                content_en: `In scenarios, you must prove participants perceived the intended differences. ncsStat runs T-tests to confirm your experimental manipulation worked.`
            }
        ]
    },
    'systematic-literature-review-slr': {
        ...
        content_structure: [
            {
                h2_vi: '1. Quy trình SLR chuyên nghiệp',
                h2_en: '1. Professional SLR Workflow',
                content_vi: `SLR không phải là đọc và kể lại. Đó là quá trình lọc tài liệu theo tiêu chí (Inclusion/Exclusion). ncsStat hướng dẫn bạn cách tổng hợp Research Gap từ hàng trăm bài báo Scopus.`,
                content_en: `SLR is a rigorous process of filtering literature based on inclusion criteria. ncsStat guides you in synthesizing research gaps from hundreds of Scopus-indexed papers.`
            }
        ]
    },
    'qualitative-coding-expert-interview': {
        ...
        content_structure: [
            {
                h2_vi: '1. Kỹ thuật Mã hóa (Coding)',
                h2_en: '1. Coding Techniques',
                content_vi: `Biến những dòng phỏng vấn dài thành các "Themes" (Chủ đề) nghiên cứu. ncsStat giúp bạn cấu trúc lại dữ liệu định tính để xây dựng thang đo mới hoặc giải thích các hiện tượng SEM phức tạp.`,
                content_en: `Transform interview text into meaningful themes. ncsStat helps structure qualitative data to build new scales or explain complex SEM phenomena.`
            }
        ]
    }
];
