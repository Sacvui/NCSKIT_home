...
export async function middleware(request: NextRequest) {
    ...
    if ((request.nextUrl.pathname.includes('/webr_repo_v2/') || request.nextUrl.pathname.includes('/webr_repo_v4/')) && 
...
export const config = {
    matcher: [
         ...
         */
        '/((?!_next/static|_next/image|favicon.ico|webr_repo_v4|webr_core_v3|.*\\.(?:svg|png|jpg|jpeg|gif|webp|tgz|gz|rds|wasm)$).*)',
    ],
}
